...
[![x-cmd/install — flowrs Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/flowrs.svg)](https://x-cmd.com/install/flowrs)
...
- **Upstream**: <https://github.com/jvanbuel/flowrs>
- **License**: MIT
